...
const AppleIdWizard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-apple-gray-50 via-white to-apple-blue/5">
      <WizardHeader
...
className="h-full flex flex-col"
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-apple-green/20 to-apple-blue/20 rounded-full blur-3xl" />
      </div>
    </div>
  )
}
